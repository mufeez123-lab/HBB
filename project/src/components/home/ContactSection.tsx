...
const ContactSection = () => {
  ...
  const isInView = useInView(ref, { once: false, margin: '-100px' }); // margin to trigger a bit before fully visible
          ...
          <div>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start">
                <div className="bg-primary-700 text-white rounded-full p-3 mr-4">
                  <Phone size={20} />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary-800 mb-1">Call Us</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-primary-800 mb-1">Email Us</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-primary-800 mb-1">Visit Us</h3>
                  <p className="text-neutral-600">
                    Corporate Office, 123 Business Park,
                    <br />
            ...
            <div className="bg-white p-6 rounded-lg shadow-soft">
              <h3 className="text-lg font-semibold text-primary-800 mb-3">Business Hours</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-secondary-500 hover:bg-secondary-600 text-white py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center"
                  >
                    Send Message
